...
function Landing() {
  ...
  return (
    <div style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem", textAlign: "center" }}>
      <div style={{ width: 64, height: 64, borderRadius: 18, marginBottom: "1.25rem", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--primary)", boxShadow: "0 8px 24px rgba(var(--primary-rgb),0.4)" }}>
        <Car size={32} strokeWidth={2} color="white" />
      </div>
      <h1 style={{ fontSize: "2rem", fontWeight: 800, marginBottom: "0.5rem" }}>FoodInCar</h1>
